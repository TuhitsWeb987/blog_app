...
import { ShowProps } from "@/types/posts";
            ...
            <div className="p-6">
              <div className="mb-6 flex justify-between items-center">
                ...
                { canEdit && (
                  <div className="flex gap-4">
                    ...
                    <button onClick={handleDelete} className="text-red-600 hover:text-red-800" transition-colors>
                      Supprimer
                    </button>
                  </div>
                )}
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 mb-8">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={handleLike} className={`transition-colors ${post.is_liked ? "text-red-600 hover:text-red-700" : "text-gray-600 hover:text-red-700"}`}>
